...
|--------|------|-----------|
| **T1** | Espaço de Escala, Pirâmide, DoG | Matheus → Henryque → Rodrigo |
| **T2** | Descritores Float vs. Binários | Matheus → Henryque → Rodrigo |
| **T3** | Montagem de Panorama (Stitching) | Matheus → Henryque → Rodrigo |
| **T4** | Descritores Neurais (DISK) | Matheus → Henryque → Rodrigo |
